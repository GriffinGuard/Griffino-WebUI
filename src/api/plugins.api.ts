...
function normalizePluginList(payload: unknown): Plugin[] {
...
function normalizeCapabilities(payload: unknown): PluginCapability[] {
  const rawItems =
...
function toFieldType(type: unknown): PluginConfigField["type"] {
  if (
    type === "string" ||
    type === "int" ||
    type === "float" ||
...
function toOptions(values: unknown): PluginConfigFieldOption[] | undefined {
...
function normalizeBootConfigResponse(payload: unknown): PluginConfigSchemaResponse {
  const record = (payload ?? {}) as Record<string, unknown>;
...
function normalizeUserConfigResponse(payload: unknown): PluginUserConfigResponse {
  const record = (payload ?? {}) as Record<string, unknown>;
...
function normalizeUserConfigValues(payload: unknown): Record<string, unknown> {
...
function normalizeStatusViews(payload: unknown): PluginStatusViewsResponse {
  const record = (payload ?? {}) as Record<string, unknown>;
...
function normalizeStatusViewData(payload: unknown): PluginStatusViewDataResponse {
  const record = (payload ?? {}) as Record<string, unknown>;
  const rawData =
...
function normalizeActions(payload: unknown): PluginActionsResponse {
  const record = (payload ?? {}) as Record<string, unknown>;
...
function normalizeTriggerActionResponse(payload: unknown): TriggerPluginActionResponse {
  const record = (payload ?? {}) as Record<string, unknown>;
  return {
...
function toNestedPluginConfig(values: Record<string, unknown>) {
